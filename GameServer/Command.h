...
namespace Command
{
	...
	public:
		...
		MoveCommand(int paramPlayerId, string paramInput, Vector3 paramCameraDirection)
			: playerId(paramPlayerId), input(paramInput), cameraDirection(paramCameraDirection) {	}
